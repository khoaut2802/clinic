                        ...
                        <Link href="/">
                            <a className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                                ...
                                <span className="ml-4 flex flex-column">
                                    <span className="text-900 lg:text-xl font-medium mb-1">Đặt câu hỏi</span>
                                    <span className="text-600 lg:text-lg">Gửi câu hỏi cho chúng tôi</span>
                                </span>
                            </a>
                        </Link>
                        <Link href="/">
                            <a className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                                ...
                                <span className="ml-4 flex flex-column">
                                    ...
                                    <span className="text-600 lg:text-lg">Liên hệ với chúng tôi</span>
                                </span>
                            </a>
                        </Link>
                        <Link href="/">
                            <a className="w-full flex align-items-center mb-5 py-5 border-300 border-bottom-1">
                                ...
                                <span className="ml-4 flex flex-column">
                                    <span className="text-900 lg:text-xl font-medium mb-1">Quyền truy cập</span>
                                    <span className="text-600 lg:text-lg">Không có quyền truy cập</span>
                                </span>
                            </a>
                        </Link>
                    </div>
